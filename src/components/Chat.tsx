...
const Chat = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto h-[90vh] bg-gradient-to-br from-[#6a0dad] via-[#ffcc00] to-[#ff6347] p-6 rounded-xl shadow-2xl text-white flex flex-col">
            {/* Header */}
            <div className="mb-4">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20 shadow-inner">
                {messages.map((msg, i) => (
            ...
            <div className="flex gap-3 mt-4">
                <input
                    ...
                    className="flex-1 bg-white/20 text-black placeholder-white/70 border border-white/30 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-yellow-400 backdrop-blur-md"
